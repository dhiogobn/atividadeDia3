		...
		for (int linhaEscolhida = 0; linhaEscolhida < 3; linhaEscolhida++) {
			for (int colunaEscolhida = 0; colunaEscolhida < 3; colunaEscolhida++) {
				if (isJogador1) {
					...
					linha = Integer.parseInt(JOptionPane.showInputDialog("Escolha a linha jogador 1: "));

					System.out.println("Escolha a coluna jogador 1: ");
					coluna = Integer.parseInt(JOptionPane.showInputDialog("Escolha a coluna jogador 1: "));
					...
					linha = Integer.parseInt(JOptionPane.showInputDialog("Escolha a linha jogador 2: "));

					System.out.println("Escolha a coluna jogador 2: ");
					coluna = Integer.parseInt(JOptionPane.showInputDialog("Escolha a linha jogador 2: "));
					if (tabuleiro[linha][coluna].equals(" ")) {
